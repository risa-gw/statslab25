...
fake_data <- data.frame("Variabble A" = c(1,2), "Variable B" = c("Yes", "No"))
...
* How would we interpret the pid coefficient of this regression?
...
* Conceptually, what is the difference between predicted probabilities versus the coefficients from our logistic regression?
