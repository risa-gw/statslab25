...
date: 'Due: Friday, Dec. 5th, 11:59 pm'
output:
...
\begin{enumerate}
    ...
    \item Both files should be submitted to the TA via e-mail (rg4895@nyu.edu) before the time specified above.
...
10.[10pts] Perform a Hausman test to compare fixed-effects and random-effects models.
