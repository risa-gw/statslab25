...
* *Question:* When do we use propensity score matching? 

* *Question:* Can propensity scores fix violations of the ignorability/no ommited variables assumption?
...
* Notice that in this example, we matched without replacement.
    * *Question:* What does it mean to match with replacement vs. matching without? 
    * *Question:* What might be the pro/cons of matching with replacement vs. without?
...
* You can also use machine learning packages like `SuperLearner` or machine learning-based arguments in the `MatchIt` and `WeightIt` packages to specify your propensity score models for you. *Question:* Why might this be a bad idea?
...
```
* *Question:* How would we interpret this coefficient? 
...
* Recall that IV estimates are **LATE** 
  * *Question:* Who is the inferential group in this design? Who can you make causal claims about? 
