...
date: 'Due: Friday, Sep 26th, 11:59 pm'
output:
  pdf_document: 
    toc: true
  html_document:
...
\begin{enumerate}
    ...
    \item Name your files following this convention: \texttt{[Last Name]\_ps1.Rmd} and \texttt{[Last Name]\_ps1.pdf} (for example, \texttt{Gelles-Watnick\_ps1.Rmd}). Please set your code chunks to show in your PDF.
    \item Both files should be submitted to the TA via e-mail (rg4895@nyu.edu) before the time specified above. Please email the TA in advance if you need extensions with justified reasons. Please plan ahead and start early.
    ...
    \item This assignment will be graded on effort, but I have left in point values in case it's helpful for figuring out how challenging/time consuming different parts will be. 
    \item Comment on your code wherever possible and explain your ideas in detail. This is good practice for future coding and will also help me give you feedback.
\end{enumerate}
