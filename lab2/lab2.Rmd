...
* The **stand error** of a sample's mean is defined as the **standard deviation** of the sampling distribution of the mean. **Question:** What is standard error telling you? What does it mean if you have a high standard error?
